...
-- Policies sur les vues M

declare
existe_deja EXCEPTION;
PRAGMA EXCEPTION_INIT(existe_deja, -28101);
BEGIN
DBMS_RLS.ADD_POLICY (
object_schema => 'AT1PP',
object_name => 'ATMDEM',
policy_name => 'ATPDEM',
function_schema => 'xdsgpp_plsql',
policy_function => 'get_pred',
statement_types => 'select');
exception
when existe_deja then
null ;
END;
/
